                ...
                <div class="card-body">
                    ...
                    @csrf 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="inputNombreIncidente" name="nombre_incidente">
                        </div>
                        <div class="mb-3">
                            <label for="inputPasos" class="form-label">Pasos a reproducir</label>
                            <textarea type="text" class="form-control" id="inputPasos" rows="4" name="pasos_reproducir"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="inputSystemInfo" class="form-label">System Info</label>
                            <textarea type="text" class="form-control" id="inputSystemInfo" rows="4" name="system_info"></textarea>
                        </div>
            ...
            <table class="table table-bordered" style="margin-top: 40px; margin-bottom: 100px;">
                ...
                <tbody align="center">
                    ...
                    <tr>
                        ...
                        <td>{{ $var->pasos_reproducir }}</td>
                        <td>{{ $var->system_info }}</td>
                        <td>
                            <button type="button" id="addola" class="btn btn-primary" style="background: #ffd000; border: none;" data-bs-placement="top" title="Vista Previa" data-bs-toggle="modal" data-bs-target="#incidenteModal" onclick="setData('{{ $var->pasos_reproducir }}');">
                    ...
                    <!--<tr>
                        <td colspan="4">
                            <evidencias-component :id-cp="{{ $var->id }}" :resultado-cp="'{{ strtoupper($var->estado) }}'" :tipo-cp="'1'"></evidencias-component>
                        </td>
                    </tr>-->
                    @endforeach
                </tbody>
...
<script type="text/javascript">
    ...
    function setData(obj){
        ...
        //var stri = obj;
        //var rct = stri.replace(/[\r\n]/gm, '');
        
        //console.log(rct)
        /*var data = JSON.parse(stri);*/
        //document.getElementById('modalNombreIncidente').value = 
        //$("#modalNombreIncidente").val(obj['']);
        //console.log(data.result);
        //console.log(Object.values(obj).nombre_incidente);
