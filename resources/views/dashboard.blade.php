                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group">
                                ...
                                <a type="button" id="pdf" class="btn btn-primary" style="background: #00cbff; border: none; margin-right: 10px;" href="{{ route('pdf', encrypt($value->id)) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="PDF">
