            ...
            @if($cp->resultado == 'pendiente')
                <div class="card" style="margin-bottom:100px; text-align: center;">
                    ...
                    <div class="card-body">
                        ...
                        <a type="button" id="fallido" class="btn btn-primary" style="background: #FF287A; border: none; margin-right: 10px;" href="{{ route('fallacp', $cp->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Fallido">
                        ...
                        <a type="button" id="exitoso" class="btn btn-primary" style="background: #019500; border: none; margin-right: 10px;" href="{{ route('exitocp', $cp->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Exitoso">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 20 20" fill="currentColor">
