...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <a href="{{ route('reporte', Auth::user()->id) }}" class="btn btn-danger" style="margin-top: 40px;" target="_blank">Reporte</a><br><br>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group">
                                ...
                                <a type="button" id="pdf" class="btn btn-primary" style="background: #00cbff; border: none; margin-right: 10px;" href="{{ route('pdf', $value->id) }}"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="PDF">
